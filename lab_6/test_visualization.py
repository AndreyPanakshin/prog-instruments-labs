...
def test_plots_generated(mock_excel_data):
    """Verify that expected plotting calls are made with correct data.

    Checks that:
    - Subplots are created (2x2)
    - Boxplot uses correct yearly data
    - Line plots are called for each of top 2 regions
    - SFO vs Russia line plot is made
    - Last subplot is turned off
    - tight_layout() is invoked
    """
